...
unmodified `quire` MVP, measures every phase, and reports what groaned
...
wrong-scale validator (`quire/entity_propose.py:207`) discards most of
...
`~/dev/scale-target/pydantic` @ 859945e47 (main, 2026-07-17). No quire
