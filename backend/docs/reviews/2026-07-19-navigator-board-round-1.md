...
**Under review:** commit dc053ba — `quire/model.py`, `GET /api/model/{ws}/around/{ref}`,
the `#/explore/<trail>` route in `quire/static/app.html`, `docs/2026-07-19-navigator-design.md`.
