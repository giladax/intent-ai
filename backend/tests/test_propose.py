...
def test_doc_cited_paths_scope_the_binding_search():
    from quire.propose import extract_doc_paths, scope_from_doc_paths

    tree = ["src/mcp/server.ts", "src/pipeline/run.ts", "backend/quire/cli.py",
    ...
    assert "backend/quire/cli.py" not in scoped  # off-topic region excluded
