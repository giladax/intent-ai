...
export const fidelityCriteria: SessionFidelityCriteria[] = [
  {
    ...
    expectedMoments: [
      ...
      { desc: "BrainCardView reversal (sibling-relative-import cause + git restore)", keywords: ["braincard"] },
      { desc: "parent_topic_id null-mask to full-removal pivot", keywords: ["parent_topic_id"] },
  ...
  },
  {
    ...
    expectedMoments: [
      ...
      // Additional from catalog §1:
      { desc: "emit-events chronology bug (all events stamped at digest time)", keywords: ["emit", "chronology"] },
    ],
    forbiddenClaims: [
