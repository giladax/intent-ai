...
1. `cd ~/dev/intent-ai/alignment && python3 -m quire_align.cli up telegram`
...
4. Done when: `python3 -m quire_align.cli proposals telegram` shows
...
python3 -m quire_align.cli up --no-open
```
